...
export const invoiceSchema = z.object({
  ...
  freelancerEmail: z.string().email("Email tidak valid").optional(),
  freelancerPhone: z.string().optional(),
  clientName: z.string().min(2, "Nama klien harus diisi"),
  clientCompany: z.string().optional(),
  clientEmail: z.string().email("Email klien tidak valid").optional(),
  ...
  const { handleSubmit, isSubmitting, resetForm, values, validate, validateField, setFieldValue, setFieldError } =
    useForm<InvoiceSchema>({
      ...
      initialValues: {
        ...
        serviceItems: [],
        discount: 0,
        paymentTerms: "Harap dibayar dalam 7 hari",
        notes: "Harga termasuk 2x revisi",
